...
<body data-sa-theme="${sessionScope.SKIN}">
	...
	<table style="width:98%;margin-top: 10px;margin-left: 1px;" >
		<tr>
			<td style="margin-top:0px;">
				 <div style="float: left;" style="width:81%"><textarea  name="USERNAME" id="USERNAME" rows="1" cols="50" style="width:625px;height:30px;" placeholder="请选输入对方用户名,多个请用(;)分号隔开" title="请选输入对方用户名,多个请用(;)分号隔开">${pd.USERNAME}</textarea></div>
		...
		<tr>
			<td style="padding-top: 3px;">
				 <script id="editor" type="text/plain" style="width:697px;height:289px;"></script>
			</td>
		</tr>
		<tr>
			<td style="text-align: center;padding-top: 15px;padding-left: 15px;" id="nr">
				<a class="btn btn-light btn--icon-text" onclick="sendFhsms();">发送</a>
    ...
    <div id="jiazai" style="display:none;width: 100%;text-align: center;" class="page-loader" >
       <div><br/><br/><br/><h4 id='msg'>正在发送..<font color="red"><strong id="second_shows">3秒</strong></font>后关闭</h4></div>
	   <div class="page-loader__spinner">
	        <svg viewBox="25 25 50 50">
	            <circle cx="50" cy="50" r="20" fill="none" stroke-width="2" stroke-miterlimit="10"></circle>
	        </svg>
	...
	<!--引入属于此页面的js -->
	<script type="text/javascript" src="static/js/fhsms.js"></script>
