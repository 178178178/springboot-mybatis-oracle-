...
<body style="background-color: rgba(255,255,255,0);">
                        ...
                        <div class="card-body">
							...
							<div>
								...
								<div style="float: left;margin-top:15px;margin-left: 20px;">
									<a class="btn btn-light btn--icon-text" onclick="connDb();">
										连接
									</a>
								</div>
							</div>
						...
						<table id="simple-table" class="table table-bordered mb-0">
							<thead>
								<tr>
						 ...
						 $.each(data.list, function(i, list){
							 if("ok" == list.msg){
								 ...
								 $.each(data.tblist, function(n, tblist){ 	//列出每条记录
									 $("#valuelist").append('<tr><td>'+(n+1)+'</td><td>'+tblist+'</td><td class="center"><a onclick="productCode(\''+tblist+'\')"><i class="zmdi zmdi-rotate-left zmdi-hc-fw"></i> 反射</a></td></tr>');
								 }); 
							 }else{
								 $("#fhdb").tips({
										side:3,
