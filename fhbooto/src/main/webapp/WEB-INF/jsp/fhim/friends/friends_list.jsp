...
<body style="background-color: rgba(255,255,255,0);">
      ...
      <div class="card" style="margin-top:5px;">
         <div class="card-body">
			...
			<!-- 检索  -->
			<form action="friends/list2" method="post" name="Form" id="Form">
			<table>
				<tr>
					<td>
				...
				<c:choose>
					<c:when test="${not empty varList}">
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								<td>
								  	<input type="checkbox" style="margin-top: 2px;" name='ids' value="${var.FRIENDS_ID}" title="${var.FUSERNAME}">
								</td>
			...
			<table style="width:100%;margin-top:15px;">
				<tr>
					<td style="vertical-align:top;">
						<shiro:hasPermission name="friends:del"><a class="btn btn-light btn--icon-text" onclick="makeAll('确定要删除选中的数据吗?');" title="批量删除">删除</a></shiro:hasPermission>
					 	<a class="btn btn-light btn--icon-text" onclick="window.location.href='<%=basePath%>friends/list';" title="切换展示">切换展示</a>
					</td>
