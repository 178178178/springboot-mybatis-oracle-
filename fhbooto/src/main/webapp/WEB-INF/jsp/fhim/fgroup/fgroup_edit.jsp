...
<body data-sa-theme="${sessionScope.SKIN}">
	...
	<div class="card-body">
		<form action="fgroup/${msg }" name="Form" id="Form" method="post">
			<input type="hidden" name="FGROUP_ID" id="FGROUP_ID" value="${pd.FGROUP_ID}"/>
			<div id="showform">
			<div class="input-group">
                <span class="input-group-addon" style="width: 79px;"><span style="width: 100%;">组名:</span></span>
                <div class="form-group">
                    <input type="text" class="form-control" name="NAME" id="NAME" value="${pd.NAME }" maxlength="32" placeholder="这里输入组名" title="组名">
