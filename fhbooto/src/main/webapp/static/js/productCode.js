 ...
 */	
	...
	function selectDid(){
		 ...
		 diag.Drag = true;
		 diag.Title = "数据字典";
		 diag.URL = locat+'/dictionaries/listAllDictToCreateCode',
		 diag.Width = 339;
		 diag.Height = 438;
	...
	function appendC(value){
		...
		$("#fields").append(
			...
			'<td style="width:100px;">'+
				...
				'<a title="编辑" onclick="editField(\''+value+'\',\''+index+'\')"><i class="zmdi zmdi-edit zmdi-hc-fw"></i></a></a>&nbsp;'+
				'<a title="删除" onclick="removeField(\''+index+'\')"><i class="zmdi zmdi-close zmdi-hc-fw"></i></a>'+
			'</td>'+
			'</tr>'
		);
		index++;
