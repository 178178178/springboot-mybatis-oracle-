...
public class ChatServer extends WebSocketServer{
	...
	public void agreefriend(String message, WebSocket conn){
		...
		try {
			...
			result.element("avatar", null == pd.get("PHOTO2")?"static/img/photo.jpg":pd.getString("PHOTO2"));			//当前用户头像
	...
	public void agreeqgroup(String message, WebSocket conn){
		...
		try {
			...
			result.element("avatar", (null == pd.getString("PHOTO") || "".equals(pd.getString("PHOTO")))?"static/img/photo.jpg":pd.getString("PHOTO"));		//群头像
