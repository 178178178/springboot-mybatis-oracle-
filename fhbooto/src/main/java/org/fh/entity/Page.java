	...
	public String getPageStr() {
		...
		if(totalResult>0){
			...
			if(currentPage==1){
				...
				sb.append("	<li><input class=\"form-control\" type=\"number\" value=\"\" id=\"toGoPage\" style=\"width:35px;text-align:center;float:left\" /></li>\n");
			...
			for(int i=startTag; i<=totalPage && i<=endTag; i++){
				if(currentPage==i)
					sb.append("<li style=\"padding-top:10px;\" class=\"active\"><a><font color='white'>&nbsp;"+i+"</font></a></li>\n");
				else
					sb.append("	<li style=\"padding-top:10px;\" style=\"cursor:pointer;\"><a onclick=\"nextPage("+i+")\">&nbsp;"+i+"</a></li>\n");
			}
			...
			sb.append("	<li style=\"padding-top:6px;\"><select title='显示条数' style=\"width:39px;float:left;margin-top:1px;border:none;background-color: rgba(255,255,255,0.6);\" onchange=\"changeCount(this.value)\">\n");
